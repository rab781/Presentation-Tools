...
# ⚡ OPTIMIZATION: Remove redundant delay to maximize command throughput.
# PresentationController already provides rate-limiting through debounce_time.
pyautogui.PAUSE = 0.0  # Remove pause between actions
