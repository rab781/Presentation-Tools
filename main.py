...
class PresentationToolApp:
    ...
    def _draw_ui(self, frame: np.ndarray) -> np.ndarray:
        ...
        # reduces the area processed for UI dimming, saving CPU cycles and
        ...
        # multiplications, we use an in-place bitwise right shift (roi >>= 1).
        # This halves all pixel values (~0.5 opacity) much faster. The slice 'roi'
        # is a view, so mutating it modifies 'frame' directly.
        roi >>= 1
