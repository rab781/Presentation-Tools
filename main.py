...
class PresentationToolApp:
    ...
    def _draw_ui(self, frame: np.ndarray) -> np.ndarray:
        ...
        roi = frame[0:120, 0:w]
        # ⚡ OPTIMIZATION: NumPy Bitwise Shift for UI Dimming
        ...
        # is computationally much faster than using cv2.addWeighted, effectively avoiding
        # heavy float multiplications.
        roi >>= 1
