...
class PresentationToolApp:
    ...
    def _draw_ui(self, frame: np.ndarray) -> np.ndarray:
        ...
        # bitwise right shift (roi >>= 1) halves pixel values for ~0.5 opacity.
        # This is computationally much faster than using cv2.addWeighted,
        # effectively avoiding heavy floating-point multiplications per pixel.
        roi >>= 1
