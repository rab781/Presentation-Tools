...
class GestureDetector:
    ...
    def detect_gesture(self, frame: np.ndarray, draw_landmarks=True) -> Tuple[Optional[str], np.ndarray]:
        ...
        # Resizing the 3-channel image first reduces the total number of pixels that
        # cv2.cvtColor must process. This significantly decreases the time spent in
        # cvtColor, outweighing the minor cost of resizing 3 channels vs 1 channel.
