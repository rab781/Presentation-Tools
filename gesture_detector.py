...
class GestureDetector:
    ...
    def detect_gesture(self, frame: np.ndarray, draw_landmarks=True) -> Tuple[Optional[str], np.ndarray]:
        ...
        # Resizing a 3-channel image first before converting it to grayscale is faster
        # because cv2.cvtColor processing time scales with the number of pixels. Reducing
