...
class VoiceRecognizer:
    ...
    def _listen_loop(self):
        ...
        # OPTIMIZATION: Open microphone stream once instead of every iteration
        # This reduces latency by avoiding repeated stream initialization
        try:
            with self.microphone as source:
                while self.is_listening:
                    try:
                        ...
                        # Short sleep to prevent busy loop on persistent error
                        time.sleep(0.1)
        except Exception as e:
