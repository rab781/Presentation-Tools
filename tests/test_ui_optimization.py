...
class TestUIOptimization(unittest.TestCase):
    ...
    def test_fast_ui_dimming_bitwise_shift(self, mock_controller):
        # Initialize app
        app = PresentationToolApp()

        # Create a mock frame and simulate slicing and in-place right shift
        frame = MagicMock()
        ...
        # Verify addWeighted was NOT called (we replaced it with >> 1)
