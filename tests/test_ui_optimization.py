...
class TestUIOptimization(unittest.TestCase):
    ...
    def test_ui_dimming_uses_bitwise_shift(self, mock_controller):
        ...
        # Create a mock frame and configure its slicing behavior for ROI
        frame = MagicMock()
        frame.shape = (480, 640, 3)
        mock_roi = MagicMock()
        frame.__getitem__.return_value = mock_roi
        # Ensure __irshift__ returns the mock itself for in-place operation
        ...
        # Verify bitwise right shift was called on the ROI with 1
