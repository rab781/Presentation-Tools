...
class TestUIOptimization(unittest.TestCase):
    ...
    def test_ui_dimming_uses_bitwise_shift(self, mock_controller):
        ...
        # Create a mock frame and configure its slicing behavior to return a mock ROI
        frame = MagicMock()
        frame.shape = (480, 640, 3)
        mock_roi = MagicMock()
        frame.__getitem__.return_value = mock_roi
        # Support bitwise operation roi >>= 1
        ...
        # Verify in-place bitwise shift was used on the ROI for dimming
