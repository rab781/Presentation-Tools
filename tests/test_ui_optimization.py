...
class TestUIOptimization(unittest.TestCase):
    ...
    def test_bitwise_shift_replaces_addweighted(self, mock_controller):
        # Initialize app
        ...
        # Setup mock for slice view to support bitwise right shift
        mock_roi = MagicMock()
        ...
        # Verify bitwise right shift was called on the ROI
