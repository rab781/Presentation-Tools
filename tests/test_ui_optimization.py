...
class TestUIOptimization(unittest.TestCase):
    ...
    def test_add_weighted_is_replaced(self, mock_controller):
        # Initialize app
        app = PresentationToolApp()

        # Create a mock frame and configure slice behavior
        frame = MagicMock()
        ...
        # Verify addWeighted was not called and right shift was used
