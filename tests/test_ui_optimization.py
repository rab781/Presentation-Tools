...
class TestUIOptimization(unittest.TestCase):
    ...
    def test_dimming_uses_bitwise_shift(self, mock_controller):
        ...
        # Configure mock ROI for slice and in-place shift
        mock_roi = MagicMock()
        ...
        # Verify addWeighted is NOT called, validating the float math avoidance
        mock_cv2.addWeighted.assert_not_called()

        # Verify bitwise shift was called on the ROI
