...
class TestUIOptimization(unittest.TestCase):
    ...
    def test_ui_dimming_uses_bitwise_shift_instead_of_add_weighted(self, mock_controller):
        # Initialize app
        app = PresentationToolApp()

        # Create a mock frame and configure slice behavior for the ROI
        frame = MagicMock()
        ...
        # Verify in-place right shift was called on the ROI
