...
**Action:** Replace `cv2.addWeighted` with `>>= 1` on the region of interest for simple halving-based dimming when exact float transparency isn't strictly necessary.
