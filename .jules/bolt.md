...
## 2025-12-25 - [Use bitwise shift for UI dimming]
...
**Action:** Replace `cv2.addWeighted` with `roi >>= 1` when creating a 50% opacity dimming effect to optimize CPU usage and reduce latency.
