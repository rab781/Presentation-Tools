...
## 2025-12-25 - [Faster UI Dimming with Bitwise Shift]
...
**Action:** Replace `cv2.addWeighted` with `>>= 1` on the region of interest for fast and simple dimming/transparency overlays without full float operations.
