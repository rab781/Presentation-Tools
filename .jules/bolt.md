...
**Action:** Replace `cv2.addWeighted` with bitwise operations when creating simple transparency overlays in hot paths to avoid floating-point operations.
