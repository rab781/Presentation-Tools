...
**Action:** Use bitwise right shifts (`>>= 1`) on the Region of Interest (ROI) instead of `cv2.addWeighted` for simple semi-transparent overlays to reduce CPU overhead.
