...
## 2025-12-26 - [Replace cv2.addWeighted with bitwise shifts for UI dimming]
...
**Action:** Use bitwise shifts like `>>= 1` instead of `cv2.addWeighted` when rendering simple semi-transparent backgrounds or dimming effects.
