...
## 2025-12-26 - [In-place bitwise shifts for UI dimming]
...
**Action:** Use bitwise right shift for UI dimming instead of `cv2.addWeighted` when an opacity of exactly 0.5 (or another power of two fraction) is acceptable.
