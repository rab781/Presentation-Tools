...
## 2025-12-26 - [Fast Bitwise UI Dimming]
...
**Action:** Replace `cv2.addWeighted` with an in-place bitwise right shift (`roi >>= 1`) for simple UI dimming to reduce CPU cycle overhead during UI rendering.
