...
## 2025-12-26 - [Use bitwise right shift instead of cv2.addWeighted for UI dimming]
...
**Action:** Replace `cv2.addWeighted` blending with a bitwise right shift (`roi >>= 1`) to avoid floating-point operations.
