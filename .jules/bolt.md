...
## 2026-06-16 - [NumPy Bitwise Shift for UI Dimming]
...
**Action:** Replace `cv2.addWeighted` with NumPy in-place bitwise right shifts when simple halving of pixel values is sufficient for the visual effect.
