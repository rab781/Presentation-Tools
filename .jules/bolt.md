...
## 2025-12-26 - [Replace cv2.addWeighted with in-place bitwise shift]
...
**Action:** Use in-place bitwise shifts (e.g., `roi >>= 1`) instead of `cv2.addWeighted` for simple dimming effects to avoid floating-point operations and improve performance.
